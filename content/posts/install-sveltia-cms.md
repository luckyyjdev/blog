...
date = 2026-06-15
draft = false
tags = [ "Hugo", "Sveltia CMS", "Cloudflare" ]
categories = [ "技术" ]
...
| `ALLOWED_DOMAINS` | `www.luckyyj.eu.org（添你的域名）` |
...
Sveltia CMS 的安装配置整体还算简单，最麻烦的部分是 GitHub OAuth 认证，好在官方提供了 Cloudflare Worker 的一键部署方案。对于 Hugo + Cloudflare Pages 的用户来说，这是一套零成本的 CMS 方案，非常棒。
